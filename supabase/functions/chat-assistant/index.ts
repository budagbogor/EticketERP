...
2. vehicle_specifications: Technical specs of vehicles.
   - Columns: brand_id, model_id, variant_name, year_start, year_end, engine_type, engine_code, transmission, engine_oil_capacity, engine_oil_type, engine_oil_quality_standard, engine_oil_replacement_interval_km, transmission_oil_capacity, transmission_oil_type, transmission_oil_replacement_interval_km, power_steering_oil_capacity, power_steering_oil_type, brake_oil_type, radiator_coolant_capacity, radiator_coolant_type, ac_freon_capacity, ac_freon_type, tire_size_front, tire_size_rear, tire_pressure_front, tire_pressure_rear, battery_type, battery_model, wiper_size_driver, wiper_size_passenger, wiper_size_rear, spark_plug_type, air_filter_type, cabin_filter_type, fuel_filter_type, oil_filter_type, brake_pad_front_type, brake_pad_rear_type, brake_disc_front_type, brake_disc_rear_type, shock_depan_recommended_brands, shock_belakang_recommended_brands, rack_end_recommended_brands, tie_rod_recommended_brands, link_stabilizer_recommended_brands, lower_arm_recommended_brands, upper_arm_recommended_brands, upper_support_recommended_brands, created_at.
